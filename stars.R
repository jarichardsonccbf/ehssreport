...
rm(cbcs.locations, jjkeller.locations, lms.locations, cbcs.cat, cbcs.pivot.cat, cbcs.years, typology.cost, typology.count, cbcs.cat.jax, cbcs.pivot.cat.jax, typology.cost.jax)

stars.a <- read_excel("data/Stars Week 4.xlsx") %>%
